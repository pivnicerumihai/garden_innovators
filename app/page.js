...
export default function Home() {
  ...
  <div className="absolute top-3/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
    <div className="bg-opacity-50 backdrop-filter backdrop-blur-xs p-4 rounded-lg">
      ...
      <ServiceCard title={'Our Services'} listArray={['Garden design and planning',
...
<ServiceCard title={'Orientative Prices'} listArray={['Item One: £25', 'Item Two: 35£', 'Item Three: £45','Item Four: £25', 'Item Five: 35£', 'Item Six: £45','Item Seven: £25', 'Item Eight: 35£', 'Item Nine: £45']}/>
      </div>
